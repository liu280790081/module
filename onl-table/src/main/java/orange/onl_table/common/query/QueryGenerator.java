...
public class QueryGenerator {
     ...
     */
    public static <T> QueryWrapper<T> initQueryWrapper(T searchObj, JSONObject parameterMap) {
     ...
     */
    public static void installMplus(QueryWrapper<?> queryWrapper, Object searchObj, JSONObject parameterMap) {
...
//                }
                ...
                if (parameterMap != null) {
                    ...
                    if (parameterMap.containsKey(name + END)) {
...
//                            return j;
    ...
    //多字段排序 TODO 需要修改前端
    public static void doMultiFieldsOrder(QueryWrapper<?> queryWrapper, JSONObject parameterMap) {
        String column = null, order = null;
        if (parameterMap != null && parameterMap.containsKey(ORDER_COLUMN)) {
            column = parameterMap.getString(ORDER_COLUMN);
        }
        if (parameterMap != null && parameterMap.containsKey(ORDER_TYPE)) {
            order = parameterMap.getString(ORDER_TYPE);
        }
     ...
     * @param parameterMap
     */
    public static void doSuperQuery(QueryWrapper<?> queryWrapper, JSONObject parameterMap) {
        if (parameterMap != null && parameterMap.containsKey(SUPER_QUERY_PARAMS)) {
            String superQueryParams = parameterMap.getString(SUPER_QUERY_PARAMS);
            // 解码
            try {
            ...
            for (QueryCondition rule : conditions) {
                if (ConvertUtils.isNotEmpty(rule.getField()) && ConvertUtils.isNotEmpty(rule.getRule()) && ConvertUtils.isNotEmpty(rule.getVal())) {
